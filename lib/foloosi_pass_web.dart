...
class FoloosiPassWeb extends FoloosiPassPlatform {
  ...
  static void registerWith(Registrar registrar) {
    FoloosiPassPlatform.instance = FoloosiPassWeb();
  }
  ...
  Future<String> signIn() async {
    ...
    try {
        ...
        try {
          ...
          if (currentUrl.contains(_redirectUri!)) {
            ...
            if (error != null) {
              if (!completer.isCompleted) {
                completer.completeError(
                  PlatformException(code: 'AUTH_ERROR', message: error),
                );
              }
            } else if (code != null) {
              if (!completer.isCompleted) {
      ...
      throw PlatformException(code: 'SIGN_IN_ERROR', message: e.toString());
    }
  }
  ...
  Future<String> getAccessToken(String code) async {
    ...
    try {
      ...
      throw PlatformException(code: 'TOKEN_ERROR', message: e.toString());
    }
  }
  ...
  Future<dynamic> getProfile(String accessToken) async {
    try {
      ...
      throw PlatformException(code: 'PROFILE_ERROR', message: e.toString());
    }
  }
